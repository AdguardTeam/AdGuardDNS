...
var _ profiledb.FileCacheStorage = (*Storage)(nil)

// Load implements the [profiledb.FileCacheStorage] interface for *Storage.
func (s *Storage) Load(ctx context.Context) (c *profiledb.FileCache, err error) {
...
func (s *Storage) Store(
	...
	err = renameio.WriteFile(s.path, b, agd.PermFileDefault)
	if err != nil {
