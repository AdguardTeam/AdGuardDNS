...
func storedData(tb testing.TB, path string, fileCache *profiledb.FileCache) (data []byte) {
	tb.Helper()
...
func BenchmarkStorage(b *testing.B) {
	...
	//	goos: darwin
	//	goarch: arm64
	//	pkg: github.com/AdguardTeam/AdGuardDNS/internal/profiledb/filecacheopb
	//	cpu: Apple M3
