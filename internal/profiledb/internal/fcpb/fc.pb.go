...
type FilterConfig_WeeklySchedule struct {
	state          protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Mon *[]*DayInterval        `protobuf:"bytes,1,rep,name=mon,proto3"`
	xxx_hidden_Tue *[]*DayInterval        `protobuf:"bytes,2,rep,name=tue,proto3"`
	xxx_hidden_Wed *[]*DayInterval        `protobuf:"bytes,3,rep,name=wed,proto3"`
	xxx_hidden_Thu *[]*DayInterval        `protobuf:"bytes,4,rep,name=thu,proto3"`
	xxx_hidden_Fri *[]*DayInterval        `protobuf:"bytes,5,rep,name=fri,proto3"`
	xxx_hidden_Sat *[]*DayInterval        `protobuf:"bytes,6,rep,name=sat,proto3"`
	xxx_hidden_Sun *[]*DayInterval        `protobuf:"bytes,7,rep,name=sun,proto3"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_fc_proto_rawDesc = "" +
	...
	"\x03mon\x18\x01 \x03(\v2\x11.fcpb.DayIntervalR\x03mon\x12#\n" +
	"\x03tue\x18\x02 \x03(\v2\x11.fcpb.DayIntervalR\x03tue\x12#\n" +
	"\x03wed\x18\x03 \x03(\v2\x11.fcpb.DayIntervalR\x03wed\x12#\n" +
	"\x03thu\x18\x04 \x03(\v2\x11.fcpb.DayIntervalR\x03thu\x12#\n" +
	"\x03fri\x18\x05 \x03(\v2\x11.fcpb.DayIntervalR\x03fri\x12#\n" +
	"\x03sat\x18\x06 \x03(\v2\x11.fcpb.DayIntervalR\x03sat\x12#\n" +
	"\x03sun\x18\a \x03(\v2\x11.fcpb.DayIntervalR\x03sun\x1a<\n" +
