...
// FilterIndexStorageMetrics is an interface that is used for the collection of
// standard access statistics.
type FilterIndexStorageMetrics interface {
...
// [FilterIndexStorageMetrics] interface that does nothing.
type EmptyFilterIndexStorageMetrics struct{}

// type check
var _ FilterIndexStorageMetrics = EmptyFilterIndexStorageMetrics{}
...
type ProfileDBMetrics interface {
	...
	IncrementInvalidDevicesCount(ctx context.Context, n uint)
...
func (EmptyProfileDBMetrics) IncrementInvalidDevicesCount(_ context.Context, _ uint) {}
