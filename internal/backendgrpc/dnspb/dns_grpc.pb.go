...
const (
	FilterIndexService_GetTyposquattingFilterIndex_FullMethodName = "/FilterIndexService/getTyposquattingFilterIndex"
	FilterIndexService_GetHomoglyphFilterIndex_FullMethodName     = "/FilterIndexService/getHomoglyphFilterIndex"
)

// FilterIndexServiceClient is the client API for FilterIndexService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
//
// *
...
type FilterIndexServiceClient interface {
	// *
	// Method getTyposquattingFilterIndex returns the global-domain filter
	// index and settings.
	//
	// TODO(a.tropnikov):  Document errors.
	GetTyposquattingFilterIndex(ctx context.Context, in *TyposquattingFilterIndexRequest, opts ...grpc.CallOption) (*TyposquattingFilterIndexResponse, error)
	// *
	// Method getHomoglyphFilterIndex returns the homoglyph filter index and
	// settings.
	//
	// TODO(a.tropnikov):  Document errors.
	GetHomoglyphFilterIndex(ctx context.Context, in *HomoglyphFilterIndexRequest, opts ...grpc.CallOption) (*HomoglyphFilterIndexResponse, error)
}

type filterIndexServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewFilterIndexServiceClient(cc grpc.ClientConnInterface) FilterIndexServiceClient {
	return &filterIndexServiceClient{cc}
}

func (c *filterIndexServiceClient) GetTyposquattingFilterIndex(ctx context.Context, in *TyposquattingFilterIndexRequest, opts ...grpc.CallOption) (*TyposquattingFilterIndexResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TyposquattingFilterIndexResponse)
	err := c.cc.Invoke(ctx, FilterIndexService_GetTyposquattingFilterIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *filterIndexServiceClient) GetHomoglyphFilterIndex(ctx context.Context, in *HomoglyphFilterIndexRequest, opts ...grpc.CallOption) (*HomoglyphFilterIndexResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HomoglyphFilterIndexResponse)
	err := c.cc.Invoke(ctx, FilterIndexService_GetHomoglyphFilterIndex_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// FilterIndexServiceServer is the server API for FilterIndexService service.
// All implementations must embed UnimplementedFilterIndexServiceServer
// for forward compatibility.
//
// *
// Service FilterIndexService defines methods for requesting indexes of filters
...
//
// TODO(a.garipov):  Add RuleListFilterIndex.
type FilterIndexServiceServer interface {
	// *
	// Method getTyposquattingFilterIndex returns the global-domain filter
	// index and settings.
	//
	// TODO(a.tropnikov):  Document errors.
	GetTyposquattingFilterIndex(context.Context, *TyposquattingFilterIndexRequest) (*TyposquattingFilterIndexResponse, error)
	// *
	// Method getHomoglyphFilterIndex returns the homoglyph filter index and
	// settings.
	//
	// TODO(a.tropnikov):  Document errors.
	GetHomoglyphFilterIndex(context.Context, *HomoglyphFilterIndexRequest) (*HomoglyphFilterIndexResponse, error)
	mustEmbedUnimplementedFilterIndexServiceServer()
}

// UnimplementedFilterIndexServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
type UnimplementedFilterIndexServiceServer struct{}

func (UnimplementedFilterIndexServiceServer) GetTyposquattingFilterIndex(context.Context, *TyposquattingFilterIndexRequest) (*TyposquattingFilterIndexResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTyposquattingFilterIndex not implemented")
}
func (UnimplementedFilterIndexServiceServer) GetHomoglyphFilterIndex(context.Context, *HomoglyphFilterIndexRequest) (*HomoglyphFilterIndexResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetHomoglyphFilterIndex not implemented")
}
func (UnimplementedFilterIndexServiceServer) mustEmbedUnimplementedFilterIndexServiceServer() {}
func (UnimplementedFilterIndexServiceServer) testEmbeddedByValue()                            {}

// UnsafeFilterIndexServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to FilterIndexServiceServer will
// result in compilation errors.
type UnsafeFilterIndexServiceServer interface {
	mustEmbedUnimplementedFilterIndexServiceServer()
}

func RegisterFilterIndexServiceServer(s grpc.ServiceRegistrar, srv FilterIndexServiceServer) {
	// If the following call panics, it indicates UnimplementedFilterIndexServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
	...
	s.RegisterService(&FilterIndexService_ServiceDesc, srv)
}

func _FilterIndexService_GetTyposquattingFilterIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TyposquattingFilterIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FilterIndexServiceServer).GetTyposquattingFilterIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilterIndexService_GetTyposquattingFilterIndex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FilterIndexServiceServer).GetTyposquattingFilterIndex(ctx, req.(*TyposquattingFilterIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _FilterIndexService_GetHomoglyphFilterIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HomoglyphFilterIndexRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FilterIndexServiceServer).GetHomoglyphFilterIndex(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilterIndexService_GetHomoglyphFilterIndex_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FilterIndexServiceServer).GetHomoglyphFilterIndex(ctx, req.(*HomoglyphFilterIndexRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// FilterIndexService_ServiceDesc is the grpc.ServiceDesc for FilterIndexService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var FilterIndexService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "FilterIndexService",
	HandlerType: (*FilterIndexServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getTyposquattingFilterIndex",
			Handler:    _FilterIndexService_GetTyposquattingFilterIndex_Handler,
		},
		{
			MethodName: "getHomoglyphFilterIndex",
			Handler:    _FilterIndexService_GetHomoglyphFilterIndex_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "dns.proto",
