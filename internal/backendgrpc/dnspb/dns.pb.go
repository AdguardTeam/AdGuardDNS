...
const file_dns_proto_rawDesc = "" +
	...
	"\x11getSessionTickets\x12\x15.SessionTicketRequest\x1a\x16.SessionTicketResponse2x\n" +
	"\x12FilterIndexService\x12b\n" +
	"\x1bgetTyposquattingFilterIndex\x12 .TyposquattingFilterIndexRequest\x1a!.TyposquattingFilterIndexResponseb\x06proto3"
...
var file_dns_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_dns_proto_goTypes = []any{
	...
	(*DeviceSettingsChange_Deleted)(nil),             // 48: DeviceSettingsChange.Deleted
	(*DeviceSettingsChange_Upserted)(nil),            // 49: DeviceSettingsChange.Upserted
	(*CustomDomain_Pending)(nil),                     // 50: CustomDomain.Pending
	(*CustomDomain_Current)(nil),                     // 51: CustomDomain.Current
	(*TyposquattingFilterIndex_ProtectedDomain)(nil), // 52: TyposquattingFilterIndex.ProtectedDomain
	(*TyposquattingFilterIndex_Exception)(nil),       // 53: TyposquattingFilterIndex.Exception
...
var file_dns_proto_depIdxs = []int32{
	...
	54, // 2: DNSProfilesRequest.sync_time:type_name -> google.protobuf.Timestamp
	...
	55, // 7: DNSProfile.filtered_response_ttl:type_name -> google.protobuf.Duration
	...
	48, // 26: DeviceSettingsChange.deleted:type_name -> DeviceSettingsChange.Deleted
	49, // 27: DeviceSettingsChange.upserted:type_name -> DeviceSettingsChange.Upserted
	9,  // 28: CustomDomainSettings.domains:type_name -> CustomDomain
	50, // 29: CustomDomain.pending:type_name -> CustomDomain.Pending
	51, // 30: CustomDomain.current:type_name -> CustomDomain.Current
	46, // 31: SafeBrowsingSettings.typosquatting:type_name -> TyposquattingFilterSettings
	25, // 32: DeviceSettings.authentication:type_name -> AuthenticationSettings
	13, // 33: ParentalSettings.schedule:type_name -> ScheduleSettings
	14, // 34: ScheduleSettings.weekly_range:type_name -> WeeklyRange
	15, // 35: WeeklyRange.mon:type_name -> DayRange
	15, // 36: WeeklyRange.tue:type_name -> DayRange
	15, // 37: WeeklyRange.wed:type_name -> DayRange
	15, // 38: WeeklyRange.thu:type_name -> DayRange
	15, // 39: WeeklyRange.fri:type_name -> DayRange
	15, // 40: WeeklyRange.sat:type_name -> DayRange
	15, // 41: WeeklyRange.sun:type_name -> DayRange
	55, // 42: DayRange.start:type_name -> google.protobuf.Duration
	55, // 43: DayRange.end:type_name -> google.protobuf.Duration
	54, // 44: DeviceBillingStat.last_activity_time:type_name -> google.protobuf.Timestamp
	24, // 45: AccessSettings.allowlist_cidr:type_name -> CidrRange
	24, // 46: AccessSettings.blocklist_cidr:type_name -> CidrRange
	0,  // 47: CreateDeviceRequest.device_type:type_name -> DeviceType
	11, // 48: CreateDeviceResponse.device:type_name -> DeviceSettings
	55, // 49: RateLimitedError.retry_delay:type_name -> google.protobuf.Duration
	24, // 50: RateLimitSettings.client_cidr:type_name -> CidrRange
	56, // 51: RemoteKVGetResponse.empty:type_name -> google.protobuf.Empty
	55, // 52: RemoteKVSetRequest.ttl:type_name -> google.protobuf.Duration
	42, // 53: SessionTicketResponse.tickets:type_name -> SessionTicket
	47, // 54: TyposquattingFilterIndexResponse.index:type_name -> TyposquattingFilterIndex
	52, // 55: TyposquattingFilterIndex.domains:type_name -> TyposquattingFilterIndex.ProtectedDomain
	53, // 56: TyposquattingFilterIndex.exceptions:type_name -> TyposquattingFilterIndex.Exception
	11, // 57: DeviceSettingsChange.Upserted.device:type_name -> DeviceSettings
	54, // 58: CustomDomain.Pending.expire:type_name -> google.protobuf.Timestamp
	54, // 59: CustomDomain.Current.not_before:type_name -> google.protobuf.Timestamp
	54, // 60: CustomDomain.Current.not_after:type_name -> google.protobuf.Timestamp
	5,  // 61: DNSService.getDNSProfiles:input_type -> DNSProfilesRequest
	22, // 62: DNSService.saveDevicesBillingStat:input_type -> DeviceBillingStat
	26, // 63: DNSService.createDeviceByHumanId:input_type -> CreateDeviceRequest
	1,  // 64: RateLimitService.getRateLimitSettings:input_type -> RateLimitSettingsRequest
	3,  // 65: RateLimitService.getGlobalAccessSettings:input_type -> GlobalAccessSettingsRequest
	34, // 66: RemoteKVService.get:input_type -> RemoteKVGetRequest
	36, // 67: RemoteKVService.set:input_type -> RemoteKVSetRequest
	38, // 68: CustomDomainService.getCustomDomainCertificate:input_type -> CustomDomainCertificateRequest
	40, // 69: SessionTicketService.getSessionTickets:input_type -> SessionTicketRequest
	44, // 70: FilterIndexService.getTyposquattingFilterIndex:input_type -> TyposquattingFilterIndexRequest
	6,  // 71: DNSService.getDNSProfiles:output_type -> DNSProfile
	56, // 72: DNSService.saveDevicesBillingStat:output_type -> google.protobuf.Empty
	27, // 73: DNSService.createDeviceByHumanId:output_type -> CreateDeviceResponse
	2,  // 74: RateLimitService.getRateLimitSettings:output_type -> RateLimitSettingsResponse
	4,  // 75: RateLimitService.getGlobalAccessSettings:output_type -> GlobalAccessSettingsResponse
	35, // 76: RemoteKVService.get:output_type -> RemoteKVGetResponse
	37, // 77: RemoteKVService.set:output_type -> RemoteKVSetResponse
	39, // 78: CustomDomainService.getCustomDomainCertificate:output_type -> CustomDomainCertificateResponse
	41, // 79: SessionTicketService.getSessionTickets:output_type -> SessionTicketResponse
	45, // 80: FilterIndexService.getTyposquattingFilterIndex:output_type -> TyposquattingFilterIndexResponse
