...
var (
	...
	_ backendgrpc.CustomDomainStorageMetrics = (*metrics.BackendCustomDomainStorage)(nil)
	_ backendgrpc.GRPCMetrics                = (*metrics.BackendGRPC)(nil)
	_ backendgrpc.FilterIndexStorageMetrics  = (*metrics.BackendFilterIndexStorage)(nil)
	_ backendgrpc.ProfileDBMetrics           = (*metrics.BackendProfileDB)(nil)
	_ backendgrpc.RemoteKVMetrics            = (*metrics.BackendRemoteKV)(nil)
	_ backendgrpc.TicketStorageMetrics       = (*metrics.BackendTicketStorage)(nil)
